...
class BuddyEdit extends Component {
  constructor(props) {
    super(props);
    this.state = {first_name: '', last_name: '', title: '', rosies: '', loading: true, active:true};
  ...
  handleSubmit () {
    ...
    axios.put(`/api/buddies/${id}`, {first_name, last_name, active, title, rosies}).then(res => {
